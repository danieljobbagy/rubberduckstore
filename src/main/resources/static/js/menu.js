...
function createMenuForNotLoggedIn() {
  ...
  navbarDiv.innerHTML = `
            <!--Logó, mint termékek/főoldal menüpont-->
                  <a href="index.html"><img src="img/finallogo3.jpg" alt="" style="width: 240px; padding-top: 13px;" /></a>
...
function createMenuForAdmin() {
  ...
  navbarDiv.innerHTML = `
                  <!--Logó, mint termékek/főoldal menüpont-->
                  <a href="index.html"><img src="img/finallogo3.jpg" alt="" style="width: 240px; padding-top: 13px; margin-left: 60px;" /></a>
                  <!--Admin dropdown menü-->
                  <div class="dropdown">
